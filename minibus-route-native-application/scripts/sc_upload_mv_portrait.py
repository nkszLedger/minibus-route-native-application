...
''' arg1 - url'''
''' arg2 - token'''
''' arg3 - portrait_file_path'''
''' arg4 - military_veteran_id'''
...
data_list.append(encode('Content-Disposition: form-data; name=portrait; filename={0}'.format(str(sys.argv[3]))))
...
conn.request("POST", "/api/militaryveteranportrait/", payload, headers)
